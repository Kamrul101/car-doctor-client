  ...
  return (
    <div className="hero min-h-screen bg-base-200 mt-5">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <img
          src={parts}
          className="w-1/2 rounded-lg shadow-2xl absolute right-12 top-1/2 border-8 border-white"
        />
        </div>
        <div className="lg:w-1/2">
            <p className="text-2xl font-semibold text-orange-600 mb-4">About us</p>
